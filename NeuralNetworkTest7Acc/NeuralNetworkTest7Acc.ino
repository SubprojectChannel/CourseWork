...
class NeuralNetwork {
  public:
    ...
    void assignFromFile(String mySDFileName) {
      ...
      mySDFile = SD.open(mySDFileName);
      Serial.println("Opening took" + String(millis()-startTime));
      startTime = millis();
      ...
      Serial.println("reading took " + String(millis()-startTime));
      startTime = millis();
      mySDFile.close();
      Serial.println("Closing took" + String(millis()-startTime));
      startTime = millis();
      if (sizeMismatch) {
